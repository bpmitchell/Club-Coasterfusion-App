...
var TITLE = "";
//RSS url
var RSS = "http://feeds.feedburner.com/CoasterfusionNews"; limit: 5
//Stores entries
var entries = [];
var selectedEntry = "";
...
s += '<li><a href="#contentPage" class="contentLink" data-entryid="'+i+'">' + '<h3>' + v.title + '</h3>' + '<div class="date">'+ v.pubDate + '</div>' + '</a></li>'
;});
$("#linksList").html(s);
